...
// Why use custom Rest URL 
//1. custom search logic
//2. respoind with less JSon data
//3. send only 1 getJSON request
//4. Good exercise to sharpen PHP skills 

// Object oriented code 
class Search {
  //1. describe our and create/initiate our object
  constructor() {
    this.addSearchHTML();
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(universityData.root_url + '/wp-json/university/v1/search?term=' + this.searchField.val(), results => {
      this.resultsDiv.html(`
                ...
                <div class="one-third">
                    ...
                    ${results.programs.length ? '<ul class="link-list min-list">' : `<p>No prgrams match that search. <a href="${universityData.root_url}/programs">View all programs</a></p>`}
    ...
    /*
         This chunk of code is using the built in wordpress rest api calls. 
        with the namespace of wp/v2
         $.when(
            ...
            this.resultsDiv.html('<p>Unexpected eror; please try again</p>')
        });
        */
  }
